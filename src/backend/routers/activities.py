...
def get_activities(
    ...
    - difficulty: Filter by difficulty level ('Beginner', 'Intermediate', 'Advanced').
      When specified, also includes activities with no difficulty set (suitable for all levels).
      Use 'none' to return only activities with no difficulty specified.
    """
    ...
    if difficulty:
        if difficulty == "none":
            ...
            # Include activities for this specific level AND those with no difficulty (for all levels)
